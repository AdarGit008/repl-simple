...
- [x] T19 — SHIP security-audit Medium fix (D27): scope the sentinel rule's marker grant to the system's own marker; note the error-branch quoted sentinel shape in the rule; honest docs Exception 5 (marker-shaped-text residual: steering-only, soft control, not authentication); test 17(c) pins
- [x] TM — reconcile F-77 tests to D19 quoting (merge of e796174) (#145)
